...
def parse_args():
    ...
    parser.add_argument(
        ...
        default='/content/conversational-movies/new_tmp',
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        help='which pretrained SentenceTransformer model to use (e.g. "all-MiniLM-L6-v2", "all-mpnet-base-v2", "all-distilroberta-v1", etc)',
    )
    parser.add_argument(
        '--seed',
        type=int,
    ...
    parser.add_argument(
        ...
        type=str,
        default='|||',
        help='Separator to use in the dataset',
    )
...
if __name__ == '__main__':
    ...
    # Make sure the directory exists before creating the log file
